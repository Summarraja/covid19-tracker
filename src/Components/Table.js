...
import CountryDataSample from '../Data/CountryData';
...
export default function DenseTable() {
  ...
  useEffect(() => {
    ...
    async function getData() {
      ...
      .then(setData)
      .catch(()=>{
        console.log("Fetch error at Table.. displaying static data..");
        setData(CountryDataSample);
      });
      
      function setData(CountryData){
